          ...
          <div class="px-3 pt-2">
            ...
            <nav class="mb-4" aria-label="breadcrumb">
              <ol class="breadcrumb flex-lg-nowrap">
                <li class="breadcrumb-item"><a class="text-nowrap" href="/categories"><i class="czi-home"></i> @lang('header.categories') </a></li>
                <li class="breadcrumb-item text-nowrap active" aria-current="page">{{$category->title}}</li>
              </ol>
            </nav>
            <!-- Content-->
            <section class="d-md-flex justify-content-between align-items-center mb-4 pb-2">
              <h1 class="h2 mb-3 mb-md-0 mr-3"><strong>{{$category->title}}</strong></h1>
            ...
            @if ( (Auth::check()) && (Auth::user()->role_id != 1) )
                ...
                Please add products to this category by clicking <strong>"Attach Product"</strong> and remove them by clicking <strong>"Detach Product"</strong>.
                <!-- Product grid-->
                      ...
                      <div class="card product-card card-static pb-3">
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            @if ( App\CategoryProduct::where('product_id',$product->id)->where('category_id',$category->id)->first() )
                            <div class="col-12">
                              <!-- Detach Product -->
                              <form id="add-product" action="{{ route('categories.removeproduct') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="input-group">
                                  <input class="form-control" name="category_id" id="category_id" value="{{$category->id}}" type="hidden">
                            ...
                            <div class="col-12">
                              <!-- Attach Product -->
                              <form id="add-product" action="{{ route('categories.addproduct') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="input-group">
                                  <input class="form-control" name="category_id" id="category_id" value="{{$category->id}}" type="hidden">
                                  <input class="form-control" name="product_id" id="product_id" value="{{$product->id}}" type="hidden">
      ...
      @section('jqueryScript')
          <script type="text/javascript">
            ...
            $('#addProduct').on('click',function(e){
                ...
                var url = 'categories/addproduct';

                $.ajax({
                    type: 'post',
                    url: "{{ URL::route('categories.addproduct') }}",
                    data : formData,
                    dataType : 'json',
